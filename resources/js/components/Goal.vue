<template>
    <div class="container-fruid h-100 pt-5">
        ...
        <i class="fa fa-plus align-middle pl-4 pr-1" data-toggle="model" data-target="#tagModel"></i><span class="align-middle">Manage Tag</span>
        ...
        <div class="modal fade" id="editGoalModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input v-modal="title" class="form-control">
                    </div>
                    <div class="modal-footer">
